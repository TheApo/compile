...
import { GameState, PlayedCard, Player, EffectResult, AnimationRequest, ActionRequired } from "../../../types";
...
export const execute = (card: PlayedCard, laneIndex: number, state: GameState, actor: Player): EffectResult => {
    ...
    const actorUncovered = newState[actor].lanes
    ...
    if (actorUncovered.length > 0) {
        ...
        const uncoverResult = handleUncoverEffect(newState, actor, highestValueActorCard.laneIndex);
